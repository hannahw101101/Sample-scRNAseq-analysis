...
# Neurons
VlnPlot(mt.all, features = c("RBFOX3", "SLC17A7", "TBR1", "GAD1", "GAD2"))

# Microglia and Astrocytes
VlnPlot(mt.all, features = c("CSF1R", "CX3CR1", "AQP4", "FGFR3"))

# Oligodendrocytes and OPCs 
VlnPlot(mt.all, features = c("SOX10", "MOG", "MOBP", "PDGFRA", "SMOC1"))

# Endothelial Cells
VlnPlot(mt.all, features = c("NOSTRIN", "CLDN5", "FLT1"))

# Pericytes and Monocytes
VlnPlot(mt.all, features = c("RGS5", "HIGD1B", "PDGFRB", "CX3CR1"))

# Macrophages and Fibroblasts and Epithelial 
VlnPlot(mt.all, features = c("CD74", "ALPL", "DCN", "IGFBP4", "WFDC2"))
